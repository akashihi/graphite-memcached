...
func config() Configuration {
	addressPtr := flag.String("host", "127.0.0.1:11211", "Memcached address")
	...
	return Configuration{Address: *addressPtr, Period: *periodPtr, MetricsHost: *metricsHostPtr, MetricsPort: *metricsPortPtr, MetricsPrefix: *metricsPrefixPtr}
}
